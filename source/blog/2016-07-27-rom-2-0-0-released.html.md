...
conf.default.create_table :quotes do
  primary_key :id
...
class QuoteRepo < ROM::Repository[:quotes]
  ...
  def create_or_update(quote)
    command(:create_or_update).call(quote)
  end
end
...
quote = quote_repo.create(quote: 'Such quote')

quote.id # 1
quote.likes # 1

quote_repo.create_or_update(quote: 'Such quote')
